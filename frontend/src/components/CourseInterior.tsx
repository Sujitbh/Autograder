...
/** Map API assignment to local UI shape */
function mapApiAssignment(a: any): Assignment {
  return {
    id: String(a.id),
...
export function CourseInterior() {
  ...
  const assignments: Assignment[] = useMemo(
    () => (apiAssignments ?? []).map(mapApiAssignment),
    [apiAssignments],
  );
  ...
  const handleDeleteAssignment = useCallback(() => {
    ...
    deleteMutation.mutate(
      { courseId, assignmentId: deleteTarget.id },
